<?php
namespace Captcha;
class ReCaptcha extends Captcha\Base {
    /**
    ...
    public function __construct() {
        ...
        if($allow_url_fopen != 'On' && $allow_url_fopen =! 1) {
            throw new WebspellException("URL FOPEN WRAPPER: allow_url_fopen is deactivated in your php configuration");
        }
        ...
        if($this->publicKey == '' || $this->privateKey == '') {
            throw new WebspellException("RECAPTCHA ERROR: You need a Api Key to use. http://recaptcha.net/api/getkey");
        }
    }
